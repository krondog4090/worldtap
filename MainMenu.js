    ...
    return (
      <ImageBackground source={mainmenu} style={styles.imageContainer}>
        <View style={styles.titleContainerMainMenu}>
          <View style={[styles.playButtonContainer, { justifyContent: 'space-evenly', flex: 0.6 }]}>
            ...
            <View style={[styles.playButtonContainerTwo, { justifyContent: 'space-evenly' }]}>
              {/* <View style={styles.playButtonContainerTime}>
                                    <Text allowFontScaling={false}style={[fontLoaded && { fontFamily: 'ncaa', color: 'white', fontSize: 24, textAlign: 'center'}]}>
                                    WORLD CUP STARTS IN
                                    </Text>
                                </View> */}
              ...
              <View style={{ top: this.state.buttonPressedThree ? 2 : 0 }}>
                ...
                >
                  ...
                  >
                    ...
                    {/* <Text allowFontScaling={false}style={fontLoaded && {fontFamily: 'ncaa', color: 'white'}}>Info</Text> */}
                  </View>
                </TouchableOpacity>
              </View>
