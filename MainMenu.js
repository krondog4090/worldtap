...
import { View, Text, ImageBackground, TouchableOpacity, StatusBar, Linking, Image } from 'react-native';
        ...
        return (
            <ImageBackground source={mainmenu} style={styles.imageContainer}>
                <View style={styles.titleContainerMainMenu}>
                        <View style={[styles.playButtonContainer, {justifyContent: 'space-evenly', flex: .6}]}>
                            <View style={styles.playButtonContainerTime}>
                                <Text
                                    style={[styles.buttonText, fontLoaded && { fontFamily: 'gamefont', color: 'grey', textShadowColor: 'black', textShadowOffset: {width: 1, height: 2}, textShadowRadius: 1, textAlign: 'center', fontSize: 36, lineHeight: 35}]}>
                                WORLD TAP
                                </Text>
                            </View>
                            ...
                            <View style={styles.playButtonContainerTime}>
                                ...
                                <Text 
                                    style={[styles.buttonText, fontLoaded && { fontFamily: 'gamefont', color: 'grey', textShadowColor: 'black', textShadowOffset: {width: 1, height: 2}, textShadowRadius: 1, textAlign: 'center', fontSize: 12}]}>
                                MADE BY: 
                                <Text 
                                    style={[styles.buttonText, fontLoaded && { fontFamily: 'ncaa', color: 'white', textShadowColor: 'grey', textShadowOffset: {width: 1, height: 2}, textShadowRadius: 1, textAlign: 'center', fontSize: 14, shadowColor: 'black', alignItems: 'center', fontSize: 18, textDecorationLine: 'underline'}]} 
                            ...
                            <View style={[styles.playButtonContainerTwo, {justifyContent: 'space-evenly'}]}>
                                ...
                                <View style={[styles.playButtonContainerTime, {flexDirection: 'column', alignContent: 'center', alignItems: 'center'}]}>
                ...
                <View style={styles.buttonLayout}>
                    <View style={{top: this.state.buttonPressed ? 2 : 0}}>
                        <TouchableOpacity
                            ...
                            <View style={styles.playButtonContainerTime}>
                                <Text 
                                    style={[styles.buttonText, fontLoaded && { fontFamily: 'gamefont', color: 'grey', textShadowColor: 'black', textShadowOffset: {width: 1, height: 2}, textShadowRadius: 1}]}>
                                PLAY
                                </Text>
                            </View>
                        </TouchableOpacity>
