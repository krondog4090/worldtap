...
import { buttonClick } from './SoundEffects';

import { ncaa } from '../../assets/fonts/ncaa.otf';

class TeamShareScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={styles.containerShare}>
                <View style={styles.flexPadding}></View>
                    ...
                    <View style={styles.titleContainerMainMenu}>
                        ...
                        <TouchableOpacity
                            ...
                            PRESS TO SHARE FOR {this.state.countryName}
                            </Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                ...
                <View style={styles.flexPadding}></View>
                <View style={styles.playButtonContainerTime}>
                <Text allowFontScaling={false}style={[styles.underText, fontLoaded && { fontFamily: 'ncaa', color: 'black', textAlign: 'center'}]}>Help {this.state.countryName} by sharing with your friends.</Text>
                </View>
...
export default withNavigation(TeamShareScreen);