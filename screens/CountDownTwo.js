    ...
    return (
      <View style={{ flexDirection: "column", alignItems: "center", justifyContent: 'center'}}>
        <View style={[styles.playButtonContainerTime, { flexDirection: "column", alignItems: "center", shadowOpacity: .2 }]}>
          <Text allowFontScaling={false}style={[fontLoaded && { fontFamily: "ncaa", color: "black", fontSize: 14, textAlign: 'center' }]}>
        ...
        <View style={[styles.playButtonContainerTime, { flexDirection: "column", alignItems: "center", shadowOpacity: .2 }]}>
          <Text allowFontScaling={false}style={[fontLoaded && { fontFamily: "ncaa", color: "black", fontSize: 14, textAlign: 'center' }]}>
                This game was made for a winner to be declared at the start of the next World Cup in <Text allowFontScaling={false}style={{color: 'red'}}>2022</Text>.
          </Text>
        </View>

        <View style={[styles.playButtonContainerTime, { flexDirection: "column", alignItems: "center", shadowOpacity: .2 }]}>
          <Text allowFontScaling={false}style={[fontLoaded && { fontFamily: "ncaa", color: "white", fontSize: 14, textAlign: 'center' }]}>
