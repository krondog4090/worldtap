...
import { addImage, subImage } from '../../assets/images/flagimages/FlagImages';
...
class TrumpsWallIndex extends React.Component {
  ...
  constructor(props) {
    ...
    this.getAddRefTrophy = this.getRef().child(
      'World_Teams/TrumpsWall/TrumpsWallTeams/Add/TrophyCount'
    );
    this.getSubRefTrophy = this.getRef().child(
      'World_Teams/TrumpsWall/TrumpsWallTeams/Sub/TrophyCount'
    );
  }
      ...
      <View style={styles.containerIndex}>
        <View style={styles.eastContainer}>
          <View style={[styles.playButtonContainerTime, { flexDirection: 'column' }]}>
            ...
            >
              {numberWithCommas(this.state.TrumpsWallTotalScore)} m
            </Text>
          </View>
        </View>
        {/* TEAMS */}
          ...
          <View>
            <View style={styles.flagBox}>
              ...
              >
                ...
                >
                  {abbreviateNumber(this.state.addTeamScore)} / 50M
                </Text>
            ...
            <View style={styles.flagBox}>
              ...
              >
                ...
                <Text
                  ...
                  style={[styles.scoreText, fontLoaded && { fontFamily: 'ncaa' }]}
                >
                  {abbreviateNumber(this.state.subTeamScore)} / 50M
                </Text>
                <Image style={styles.trophyBox} source={nbaTrophy} />
                <Text
                  allowFontScaling={false}
